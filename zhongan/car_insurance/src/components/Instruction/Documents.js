...
import Paper from '../public/Paper'
    ...
    render(){ 
      return (
        <div className={style.documents}>
          <ul>
            <li><a href={`${ctx}/static/pdf/zhongan/jcryywsh.pdf`} target="_blank">驾乘人员意外伤害保险条款</a></li>
            <li><a href={`${ctx}/static/pdf/zhongan/ttywshyl.pdf`} target="_blank">附加团体意外伤害医疗保险条款</a></li>
            <li><a href={`${ctx}/static/pdf/zhongan/ttzyjt.pdf`} target="_blank">团体住院津贴医疗保险条款</a></li>
          </ul>
          <p className={this.state.show ? style.all : ''}>
            ...
            3、本保险产品被保险人为持有公安机关交通管理部门核发的有效机动车驾驶证的、或乘坐机动车辆的、身体健康的自然人；<br />
            ...
            9、阅读条款：投保前请您认真阅读《驾乘人员意外伤害保险条款》（众安备-意外伤害【2015】主9号），了解保险责任及责任免除，尤其是对其中免除保险人责任的条款（包括但不限于责任免除、投保人被保险人义务、保险金申请与给付等），请充分理解并接受上述内容同意以此作为订立保险合同的依据；<br />
