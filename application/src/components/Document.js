...
export default class BusinessTravel extends Component {
    constructor(props) {
        super(props);
            ...
            <div className="business_travel">
                ...
                <table className="staff_info">
                    <tbody>
                        ...
                        <tr>
                            <td className="item">外出事由：</td>
                            <td colSpan="3">{detail.memo}</td>
                        </tr>
                        <tr>
                            <td className="item">外出地点：</td>
                            <td colSpan="3">{detail.provinceName + detail.regionName + detail.countyName + detail.movePlace}</td>
                        </tr>
                        <tr>
